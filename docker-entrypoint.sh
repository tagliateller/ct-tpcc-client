...
mysql -u root --password=my-secret-pw -h $MYSQL_PORT_3306_TCP_ADDR -D tpcc3000 < /opt/tpcc-mysql/create_table.sql
echo "Metaschema wurde geladen"

# tpcc-load ausführen
echo "Daten werden geladen"
/opt/tpcc-mysql/tpcc_load -h $MYSQL_PORT_3306_TCP_ADDR -d tpcc3000 -u root -p "my-secret-pw" -w 10
